...
module.exports.createRoom = function(room) {
  ...
  if (room.beenthere === true){result += '   ' + room.name + room.name + room.name + '   ' ;} // this is where you WERE
  else if(room.beenthere === null){result += '    ' + room.name + '    '; }    // this is where you NEVER were
  else if (room.beenthere === false){result += '***' + room.name + room.name + room.name + '***'; }  //this is where you ARE
